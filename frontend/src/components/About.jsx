        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-primary-100 shadow-lg rounded-lg p-8">
            <p className="text-lg text-primary-700 mb-6">
              Welcome to HospitalityHub, your ultimate destination for discovering and booking the best restaurants in town.
            ...
            <p className="text-lg text-primary-700">
              At HospitalityHub, we believe that great food brings people together. Join our community and embark on
